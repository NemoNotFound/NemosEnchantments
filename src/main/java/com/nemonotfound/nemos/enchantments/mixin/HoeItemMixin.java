...
import static com.nemonotfound.nemos.enchantments.utils.EnchantmentUtils.getEnchantmentLevel;
...
public class HoeItemMixin extends Item {
    ...
    public boolean canMine(ItemStack itemStack, BlockState state, World world, BlockPos pos, LivingEntity user) {
        ...
        if (isBlockCropBlock) {
            boolean hasFarmersKnowledge = hasEnchantment(world, Enchantments.FARMERS_KNOWLEDGE, hoe);
    ...
    public boolean postMine(ItemStack stack, World world, BlockState state, BlockPos pos, LivingEntity miner) {
        ...
        boolean hasHoeReaperEnchantment = hasEnchantment(world, Enchantments.REAPER, hoe);

        if (isBlockCropBlock && hasHoeReaperEnchantment) {
            int enchantmentLevel = getEnchantmentLevel(world, Enchantments.REAPER, hoe);
    ...
    private void nemosFarming_breakBlock(World world, BlockState blockState, BlockPos pos, LivingEntity breakingEntity) {
        ...
        if (!hasEnchantment(world, Enchantments.REPLANTING, breakingEntity.getMainHandStack()) && nemosFarming_setBlockState(world, pos)) {
