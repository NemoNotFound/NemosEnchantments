...
public abstract class AllayMixin extends Entity {
    ...
    private boolean shouldNotDrop(boolean original, @Local(name = "itemStack") net.minecraft.world.item.ItemStack itemStack) {
        return original && !hasEnchantment(this.level(), Enchantments.SOUL_BINDING, itemStack);
    }
}
